    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8 sm:py-12 pb-24">
      ...
      {!isLoaded ? (
        ...
        <div className="mt-6 rounded-2xl border border-dashed border-brand-border bg-[#111319] px-6 py-20 sm:py-28 text-center shadow-inner">
          ...
          <Link
            href="/"
            className="mt-6 inline-flex rounded-full bg-[#CCFF00] px-7 py-3 text-xs sm:text-sm font-black uppercase tracking-wider text-black transition-all hover:bg-[#de00b9] hover:shadow-lg hover:shadow-[#CCFF00]/20 active:scale-95"
          >
            Go to workouts
          </Link>
        </div>
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1.5 rounded-full px-4 py-2 text-xs font-black uppercase tracking-wider transition ${
                        completed
                          ...
                          : "bg-[#CCFF00] text-black hover:bg-[#d8eb82] shadow-sm hover:shadow-[#CCFF00]/20 active:scale-95"
                      }`}
                    >
