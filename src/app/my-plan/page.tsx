        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8 sm:py-12 pb-24">
                                ...
                                {(
                                    ...
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-2 text-xs sm:text-sm transition flex items-center justify-between ${
                                            sortBy === opt
                                                ? 'bg-[#222735] text-brand-lime font-bold'
            ...
            {!isLoaded ? (
                <div className="py-20 text-center flex flex-col items-center justify-center">
                    <Loader2 className="w-8 h-8 animate-spin text-brand-lime mb-3" />
                ...
                <div className="mt-6 rounded-2xl border border-dashed border-brand-border bg-[#111319] px-6 py-20 sm:py-28 text-center shadow-inner">
                    ...
                    <Link
                        href="/"
                        className="mt-6 inline-flex rounded-full bg-brand-lime px-7 py-3 text-xs sm:text-sm font-black uppercase tracking-wider text-black transition-all hover:bg-[#de00b9] hover:shadow-lg hover:shadow-brand-lime/20 active:scale-95"
                    >
                        Go to workouts
                    </Link>
                </div>
                                    ...
                                    <div className="relative h-20 w-28 sm:h-24 sm:w-36 shrink-0 rounded-xl overflow-hidden bg-[#181c25]">
                                        ...
                                        {completed && (
                                            <div className="absolute inset-0 bg-brand-bg/60 flex items-center justify-center backdrop-blur-[1px]">
                                                <span className="bg-brand-lime text-black font-black text-[10px] px-2 py-0.5 rounded-full uppercase tracking-wider flex items-center gap-1 shadow-md">
                                    ...
                                    {activeTab === 'today' && (
                                        <button
                                            ...
                                            className={`flex items-center gap-1.5 rounded-full px-4 py-2 text-xs font-black uppercase tracking-wider transition ${
                                                completed
                                                    ? 'bg-[#1f281a] border border-[#3b5428] text-brand-lime'
                                                    : 'bg-brand-lime text-black hover:bg-[#d8eb82] shadow-sm hover:shadow-brand-lime/20 active:scale-95'
                                            }`}
                                        >
                                            <Check className="w-3.5 h-3.5" />
                                            <span>
