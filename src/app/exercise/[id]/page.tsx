    ...
    useEffect(() => {
        ...
        const loadWorkout = async () => {
            try {
                ...
                console.warn(
                    'API fetch error, falling back to local dataset',
                    err,
                );
            }
                ...
                <div className="lg:col-span-6 flex flex-col">
                    ...
                    <div className="mt-10 flex flex-col sm:flex-row gap-3">
                        ...
                        <button
                            ...
                            disabled={saved}
                            className={`flex-1 flex items-center justify-center gap-2 rounded-xl px-6 py-3.5 text-xs sm:text-sm font-semibold transition ${
                                saved
