...
const NotFound = () => {
    return (
        <div className="mx-auto max-w-4xl px-4 sm:px-6 py-28 text-center flex flex-col items-center justify-center">
            ...
            <Link
                href="/"
                className="inline-flex items-center gap-2 rounded-full bg-[#CCFF00] px-7 py-3 text-xs sm:text-sm font-black uppercase tracking-wider text-black transition-all hover:bg-brand-hover hover:shadow-lg hover:shadow-[#CCFF00]/20 active:scale-95"
            >
