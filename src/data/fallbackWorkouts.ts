...
export const fallbackWorkouts: Workout[] = [
    ...
    },
    {
        ...
        rating: 4.7,
        description:
            'Bodyweight vertical pull for wide lats, upper back thickness, and biceps recruitment.',
        instructions: [
    ...
    },
    {
        ...
        rating: 4.9,
        description:
            'The king of lower-body movements targeting quads, glutes, hamstrings, and trunk rigidity.',
        instructions: [
    ...
    },
    {
        ...
        rating: 4.6,
        description:
            'Strict vertical press building boulder shoulders, upper chest fibers, and standing balance.',
        instructions: [
    ...
    },
    {
        ...
        rating: 4.3,
        description:
            'Isolation movement focused on peak bicep contraction and controlled eccentric stretch.',
        instructions: [
    ...
    },
    {
        ...
        rating: 4.4,
        description:
            'Gymnastic core hold establishing unbreakable anterior chain tension and ribcage control.',
        instructions: [
    ...
    },
    {
        ...
        rating: 4.2,
        description:
            'Full-body metabolic conditioning drill driving heart rate and explosive power endurance.',
        instructions: [
    ...
    },
    {
        ...
        rating: 4.9,
        description:
            'The quintessential posterior chain lift testing raw hip hinge power and spine stabilization.',
        instructions: [
    ...
    },
    {
        ...
        rating: 4.5,
        description:
            'Foundational pressing pattern building chest, triceps, and serratus anterior strength.',
        instructions: [
    ...
    },
    {
        ...
        rating: 4.4,
        description:
            'Dynamic unilateral leg movement improving quad and glute symmetry and knee stability.',
        instructions: [
    ...
    },
    {
        ...
        rating: 4.1,
        description:
            'Rotational core exercise honing obliques and hip flexor endurance in a V-sit posture.',
        instructions: [
    ...
    },
    {
        ...
        rating: 4.7,
        description:
            'Ballistic hip snap developing explosive glute power, grip endurance, and cardiovascular capacity.',
        instructions: [
